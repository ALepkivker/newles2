		...
		$.ajax({
			...
			error: getStorage(function(res){
				for(var field in res){
					...
					$("#rssContent").append('<div class="feed"><div class="images"><img src='+ url_img + '  width='+ width + 'px /></div><div class="title">'+ title +'</div><div class="description">'+ description +'</div></div>');
